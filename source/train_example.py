...
def create_single_football_env(args):
    ...
    env = football_env.create_environment(\
            env_name=args.env_name, representation='extracted', number_of_left_players_agent_controls=args.n_agents, rewards='scoring', write_video=True, write_full_episode_dumps=False, logdir='./logs/videos', dump_frequency=25)#, with_checkpoints=False, 
            #)
    # env = football_env.create_environment(\
