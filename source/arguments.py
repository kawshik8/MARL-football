...
def get_args():
    ...
    parse.add_argument('--polyak-tau', type=float, default=0.01, help='gae coefficient')
    ...
    parse.add_argument('--action-dim', type=int, default=1, help='hidden dim of action rep')
